                ...
                <div id="stylish" class="myform"> 
                    ...
                    <form action="../api/api_tambah.php" method="post" id="form"> 
                        <div class="form-group"> 
                            ...
                            <input type="text" name="nama_produk" id="nama_produk" placeholder="Nama 
Produk" aria-describedby="helpId"> </div> 
                        <div class="form-group"> 
...
aria-describedby="helpId"> </div> 
                        <div class="form-group"> 
                            ...
                            <input type="text" name="harga" id="harga" placeholder="Harga" aria
describedby="helpId"> </div> 
                        <div class="form-group"> 
                            <label for="">Stok</label> 
                            <input type="text" name="stok" id="stok" placeholder="Stok" aria
describedby="helpId"> </div> 
                        <div class="form-group"> 
